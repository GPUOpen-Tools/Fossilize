...
void rgPsoCreateInfoVulkan::InitializeDescriptorSetLayoutCreateInfo()
{
    // Create and zero out a single create info structure.
    VkDescriptorSetLayoutCreateInfo* pDescriptorSetLayoutCreateInfo = new VkDescriptorSetLayoutCreateInfo{};
    pDescriptorSetLayoutCreateInfo->sType = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO;
    pDescriptorSetLayoutCreateInfo->flags = 0;
    pDescriptorSetLayoutCreateInfo->bindingCount = 0;
    pDescriptorSetLayoutCreateInfo->pBindings = nullptr;

    // Add the create info structure to our collection.
...
void rgPsoGraphicsVulkan::Initialize()
{
    ...
    // Initialize the descriptor set layout create info.
    InitializeDescriptorSetLayoutCreateInfo();
...
void rgPsoCreateInfoVulkan::AddDescriptorSetLayoutCreateInfo(VkDescriptorSetLayoutCreateInfo* pDescriptorSetLayoutCreateInfo)
{
    ...
    m_pPipelineLayoutCreateInfo->setLayoutCount = m_descriptorSetLayoutCreateInfo.size();
}
...
void rgPsoGraphicsVulkan::InitializeViewportStateCreateInfo()
{
    ...
    m_pViewportStateCreateInfo->pViewports = new VkViewport{ 0, 0, 1, 1, 0, 1 };
    m_pViewportStateCreateInfo->scissorCount = 1;
    m_pViewportStateCreateInfo->pScissors = new VkRect2D{ { 0, 0 },{ 1, 1 } };
...
rgVkPipelineLayoutCreateInfo::rgVkPipelineLayoutCreateInfo()
{
    // Reset the pointer to the original object.
    memset(m_pVkPipelineLayoutCreateInfo, 0, sizeof(VkPipelineLayoutCreateInfo));
}
